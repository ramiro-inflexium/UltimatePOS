...
class ImportSalesController extends Controller
{
    ...
    private function __importFields()
    {
    	$fields =  [
    		...
    		'customer_name' => __('sale.customer_name'),
    		'customer_phone_number' => __('lang_v1.customer_phone_number'),
    		'customer_email' => __('lang_v1.customer_email'),
    		'date' => __('sale.sale_date'),
    		'product' => __('lang_v1.product_name_single_only'),
    		'sku' => __('lang_v1.product_sku'),
    		'quantity' => __('lang_v1.quantity'),
    		'unit' => __('lang_v1.product_unit'),
    		'unit_price' => __('sale.unit_price'),
    		'item_tax' => __('lang_v1.item_tax'),
    		'item_discount' => __('lang_v1.item_discount'),
    		'item_description' => __('lang_v1.item_description'),
    		'order_total' => __('lang_v1.order_total'),
    	];

    	$is_types_service_enabled = $this->moduleUtil->isModuleEnabled('types_of_service');

    	if ($is_types_service_enabled) {
    		$fields['types_of_service'] = __('lang_v1.types_of_service');
    		$fields['service_custom_field1'] = __('lang_v1.service_custom_field_1');
    		$fields['service_custom_field2'] = __('lang_v1.service_custom_field_2');
    		$fields['service_custom_field3'] = __('lang_v1.service_custom_field_3');
    		$fields['service_custom_field4'] = __('lang_v1.service_custom_field_4');
    	}
