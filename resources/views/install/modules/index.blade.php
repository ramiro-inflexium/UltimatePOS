                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <label id="module-error" class="error" for="module">
                            </label>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var validator = $('form#upload_module_form').validate();
    ...
    $("#module").fileinput({'showUpload':false, 'showPreview':false, 'browseLabel': LANG.file_browse_label, 'removeLabel': LANG.remove});
